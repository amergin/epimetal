...
win.directive('window', ['$compile', '$injector', '$timeout',
  function($compile, $injector, $timeout) {
    return {
      scope: false,
      // must be within packery directive
      require: '^packery',
      restrict: 'C',
      controller: ['$scope', '$http', 'constants', 'DatasetFactory', '$q',
        function($scope, $http, constants, DatasetFactory, $q) {

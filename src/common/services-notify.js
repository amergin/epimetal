...
serv.factory('NotifyService', [ '$injector', function NotifyService($injector) {
...
var _ModalInstanceCtrl = function($scope, $modalInstance) {
  ...
  return {
    ...
    addSticky: function(message, level) {
      return _getGrowlCallFn(level)("<strong>" + message + "</strong>", {enableHtml: true});
    },

    addTransient: function(message,level) {
      return _getGrowlCallFn(level)(message, {ttl: 7000});
    },

...
(function() {
	...
	statDist.chisqrdistr = function() {
		return chisqrdistr.apply(root, arguments);
	};
	...
	statDist.udistr = function() {
		return udistr.apply(root, arguments);
	};
	...
	statDist.tdistr = function() {
		return tdistr.apply(root, arguments);
	};
	...
	statDist.fdistr = function() {
		return fdistr.apply(root, arguments);
	};
	...
	statDist.uprob = function() {
		return uprob.apply(root, arguments);
	};
	...
	statDist.chisqrprob = function() {
		return chisqrprob.apply(root, arguments);
	};	
	...
	statDist.tprob = function() {
		return tprob.apply(root, arguments);
	};	
	...
	statDist.fprob = function() {
		return fprob.apply(root, arguments);
	};
